...
const Gallery = () => {
  const images = [
    { src: "/images/asphalt-paver.jpg", title: "Asphalt Paver", description: "Used specifically in road building projects to evenly spread asphalt out over roadway surfaces for improved durability and a smooth driving experience for vehicles, asphalt pavers provide durable roads with durable surfaces on which vehicles can travel securely and smoothly." },
    ...
    { src: "/images/bulldozer.jpg", title: "Bulldozer", description: " Used extensively during site preparation, this powerful machine pushes, levels, and clears soil surfaces, creating smooth and even surfaces. 4. [Concrete Mixer]: Essential in construction projects of all sorts, the concrete mixer blends cement, sand gravel, and water into high-quality concrete for various jobs." },
    ...
    { src: "/images/concrete-mixer.jpg", title: "Concrete Mixer", description: "This machine mixes concrete, sand and gravel together with water to create concrete, which is a key component for the majority of construction projects." },
    ...
    { src: "/images/crawler-crane.jpg", title: "Crawler Crane", description: "These heavy-duty cranes are specifically designed to tackle larger projects and capable of lifting and moving massive loads with precision. 23. Tower Crane: Essential in high-rise construction sites, this tall crane provides easy material placement at various heights." },
